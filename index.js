...
genText.addEventListener("click", function() {
  let messages = [
    ...
    "May you be gifted with lifes biggest joys and never-ending bliss.",
    ...
    "May this year give you lots of opportunities to reach your desired goals.",
    "You have no idea the amount of happiness you brought into my life.",
    "Pang 100 na message na ito pero Hempi birthday pa rin",
